...
import { ErrorList, Field, SelectField, TextareaField } from "#app/components/forms";
...
export function ChallengeEditor(
  { challenge }: {
    challenge?: SerializeFrom<Pick<Challenge, 'id' | 'name' | 'description' | 'type' | 'status'>>
  }) {
  ...
  return (
    <div className="absolute inset-0">
      <FormProvider context={form.context}>
        <Form method="POST" className="flex h-full flex-col gap-y-4 overflow-y-auto overflow-x-hidden px-10 pb-28 pt-12"
        {...getFormProps(form)}>
