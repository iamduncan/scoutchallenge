    ...
    if ($isRangeSelection(selection)) {
      ...
      if (elementDOM !== null) {
        ...
        if ($isListNode(element)) {
          ...
          const type = element.getTag() as keyof typeof blockTypeToBlockName;
          setBlockType(type);
        } else {
          const type = $isHeadingNode(element)
            ? (element.getTag() as keyof typeof blockTypeToBlockName)
            : (element.getType() as keyof typeof blockTypeToBlockName);
          setBlockType(type);
